...
namespace ImGui
{
    ...
    IMGUI_API bool          CustomSlider(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0); // Custom
    ...
    // Custom
    IMGUI_API bool          CustomSliderFloat(const char* title, const char* label, float* v, float v_min, float v_max, const char* format = "%.1f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          CustomSliderInt(const char* title, const char* label, int* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
